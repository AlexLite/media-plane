...
export const SPREADSHEET_PROPERTY_DETAILS: {
  ...
  created_on: {
    ...
    ascendingOrderTitle: "Новые",
    descendingOrderKey: "created_at",
    descendingOrderTitle: "Старые",
    icon: "CalendarDays",
  },
  due_date: {
  ...
  estimate: {
    ...
    ascendingOrderTitle: "Меньше",
    descendingOrderKey: "-estimate_point__key",
    descendingOrderTitle: "Больше",
  ...
  priority: {
    ...
    ascendingOrderTitle: "Без приоритета",
    descendingOrderKey: "-priority",
    descendingOrderTitle: "Срочный",
  ...
  link: {
    ...
    ascendingOrderTitle: "Больше",
    descendingOrderKey: "link_count",
    descendingOrderTitle: "Меньше",
    icon: "Link2",
  },
  attachment_count: {
