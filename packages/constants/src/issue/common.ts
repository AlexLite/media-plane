...
export const SPREADSHEET_PROPERTY_DETAILS: {
  ...
  created_on: {
    ...
    ascendingOrderI18nKey: "common.sort.newest",
    descendingOrderKey: "created_at",
    descendingOrderTitle: "Oldest",
    descendingOrderI18nKey: "common.sort.oldest",
    icon: "CalendarDays",
  },
  due_date: {
  ...
  estimate: {
    ...
    ascendingOrderTitle: "Lower",
    ascendingOrderI18nKey: "common.sort.lower",
    descendingOrderKey: "-estimate_point__key",
    descendingOrderTitle: "Higher",
    descendingOrderI18nKey: "common.sort.higher",
  ...
  priority: {
    ...
    ascendingOrderI18nKey: "common.none",
    descendingOrderKey: "-priority",
    descendingOrderTitle: "Urgent",
    descendingOrderI18nKey: "issue.priority.urgent",
  ...
  link: {
    ...
    ascendingOrderTitle: "Higher",
    ascendingOrderI18nKey: "common.sort.higher",
    descendingOrderKey: "link_count",
    descendingOrderTitle: "Lower",
    descendingOrderI18nKey: "common.sort.lower",
    icon: "Link2",
  },
  attachment_count: {
