...
export default {
  toast_messages: {
    adding_module_to_favorites: "Adding module to favorites...",
    adding_project_to_favorites: "Adding project to favorites...",
    an_error_occurred: "An error occurred",
    archive_success: "Archive success",
    archiving: "Archiving",
    asset_duplication_failed_please_try_again_later: "Asset duplication failed. Please try again later.",
    attachment_not_removed: "Attachment not removed",
    attachment_not_uploaded: "Attachment not uploaded",
    attachment_removed: "Attachment removed",
    attachment_uploaded: "Attachment uploaded",
    cannot_move_work_item: "Cannot move work item",
    copied_to_clipboard: "Copied to clipboard",
    copy_failed: "Copy failed",
    cycle_could_not_be_archived_please_try_again: "Cycle could not be archived. Please try again.",
    cycle_created_successfully: "Cycle created successfully.",
    cycle_deleted_successfully: "Cycle deleted successfully.",
    cycle_updated_successfully: "Cycle updated successfully.",
    deleted_successfully: "Deleted successfully!",
    deleting: "Deleting",
    drag_and_drop_is_disabled_for_the_current_grouping: "Drag and drop is disabled for the current grouping",
    error: "Error",
    error_archiving_the_issue: "Error archiving the issue",
    error_hiding_tab: "Error hiding tab:",
    error_in_creating_cycle_please_try_again: "Error in creating cycle. Please try again.",
    error_in_deleting_issue: "Error in deleting issue:",
    error_in_removing_issue_from_cycle: "Error in removing issue from cycle:",
    error_in_removing_issue_from_module: "Error in removing issue from module:",
    error_in_uploading_file: "Error in uploading file.",
    error_showing_tab: "Error showing tab:",
    error_updating_theme: "Error updating theme:",
    error_uploading_cover_image: "Error uploading cover image:",
    error_uploading_project_cover_image: "Error uploading project cover image:",
    error_: "Error!",
    estimate_creation_failed: "Estimate creation failed",
    estimate_deleted: "Estimate deleted",
    failed: "Failed",
    failed_to_apply_theme: "Failed to apply theme:",
    failed_to_copy_work_item_id: "Failed to copy work item ID",
    failed_to_import_theme_configuration: "Failed to import theme configuration",
    failed_to_load_page: "Failed to load page",
    failed_to_perform_this_action: "Failed to perform this action",
    failed_to_restore_page_version: "Failed to restore page version.",
    failed_to_save_page: "Failed to save page",
    failed_to_update_the_theme: "Failed to update the theme",
    failed_to_update_theme_please_try_again: "Failed to update theme. Please try again.",
    failed_to_upload_cover_image: "Failed to upload cover image",
    invitations_sent_successfully: "Invitations sent successfully.",
    label_with_the_same_name_already_exists_in_the_project: "Label with the same name already exists in the project",
    ...
    module_could_not_be_created_please_try_again: "Module could not be created. Please try again.",
    module_could_not_be_updated_please_try_again: "Module could not be updated. Please try again.",
    module_removed_from_favorites: "Module removed from favorites.",
    only_admin_or_creator_can_delete_the_work_item: "Only admin or creator can delete the work item",
    only_one_file_can_be_uploaded_at_a_time: "Only one file can be uploaded at a time.",
    oops: "Oops!",
    page_could_not_be_created_please_try_again: "Page could not be created. Please try again.",
    ...
    removing_module_from_favorites: "Removing module from favorites...",
    removing_project_from_favorites: "Removing project from favorites...",
    restoring: "Restoring",
    selected_work_items_could_not_be_added_to_the_cycle_please_try_again: "Selected work items could not be added to the cycle. Please try again.",
    ...
    state_could_not_be_created_please_try_again: "State could not be created. Please try again.",
    success: "Success!",
    the_attachment_could_not_be_uploaded: "The attachment could not be uploaded",
    the_attachment_has_been_successfully_uploaded: "The attachment has been successfully uploaded",
    the_link_could_not_be_created: "The link could not be created",
    ...
    warning: "Warning!",
    work_item_id_copied_to_clipboard: "Work item ID copied to clipboard",
    work_items_added_to_the_cycle_successfully: "Work items added to the cycle successfully.",
    you_are_not_allowed_to_move_this_work_item: "You are not allowed to move this work item",
    your_archives_can_be_found_in_project_archives: "Your archives can be found in project archives.",
  },
  submit: "Submit",
  cancel: "Cancel",
  loading: "Loading",
  ...
  common: {
    ...
    locked: "Locked",
    drop_here: "Drop here...",
    drop_here_to_delete: "Drop here to delete the work item.",
  ...
  attachment: {
    ...
    delete_confirmation: "Are you sure you want to delete attachment - {name}? This attachment will be permanently removed. This action cannot be undone.",
  },
  label: {
    select: "Add labels",
  ...
  onboarding_profile_setup: {
    ...
    profile_step: {
      ...
      image_upload: {
        ...
        too_large: "The image size cannot exceed 5 MB.",
        invalid_format: "Please upload a file in a valid format.",
        formats: "Supported formats: .jpeg, .jpg, .png, .webp",
        removing: "Removing",
        remove: "Remove",
        cancel: "Cancel",
        uploading: "Uploading",
  ...
  workspace_settings: {
    ...
    settings: {
      ...
      members: {
        ...
        remove_confirmation: "Are you sure you want to remove member {name}? They will no longer have access to this workspace. This action cannot be undone.",
        details: {
          full_name: "Full name",
          display_name: "Display name",
      ...
      groups: {
        title: "Groups",
        description: "Create workspace-level groups like Editor, Director, Motion, or Producer to organize people for future planning and analytics.",
        add_group: "Add group",
        ...
        empty_state: "Create groups like Editor, Director, Motion, or Producer to organize members and future analytics.",
        name_placeholder: "Editors",
        emoji_placeholder: "🎬",
  ...
  project_settings: {
    ...
    members: {
      ...
      remove_title: "Remove {name}?",
      leave_confirmation: "Are you sure you want to leave the {name} project? You will be able to join the project if invited again or if it is public.",
      remove_confirmation: "Are you sure you want to remove member {name}? They will no longer have access to this project. This action cannot be undone.",
      invite_members: {
  ...
  project_cycles: {
    ...
    add_date: "Add date",
    filters: {
      status_of_cycle: "Status of the cycle{count}",
    },
    active_cycle: {
      label: "Active cycle",
      progress: "Progress",
