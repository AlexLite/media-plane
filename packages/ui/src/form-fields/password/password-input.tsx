  ...
  return (
    <div className="relative">
      <input
        ...
        placeholder={placeholder ?? t("auth.common.password.placeholder")}
      ...
      {showToggle && (
        <Tooltip
          tooltipContent={
            showPassword
              ? t("accessibility.aria_labels.auth_forms.hide_password")
              : t("accessibility.aria_labels.auth_forms.show_password")
          }
          position="top"
        >
          <button
