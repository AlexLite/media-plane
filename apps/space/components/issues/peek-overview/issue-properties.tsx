      ...
      <div className={`space-y-2 ${mode === "full" ? "pt-3" : ""}`}>
        ...
        <div className="flex h-8 items-center gap-3">
          <div className="flex w-1/4 flex-shrink-0 items-center gap-1 text-13 text-tertiary">
            ...
            <span>{t("space_issue.priority")}</span>
          </div>
          <div className="w-3/4">
            <div
        ...
        <div className="flex h-8 items-center gap-3">
          <div className="flex w-1/4 flex-shrink-0 items-center gap-1 text-13 text-tertiary">
            ...
            <span>{t("space_issue.due_date")}</span>
          </div>
          <div>
            {issueDetails.target_date ? (
              ...
              <span className="text-13 text-secondary">{t("space_issue.empty")}</span>
            )}
          </div>
        </div>
      </div>
