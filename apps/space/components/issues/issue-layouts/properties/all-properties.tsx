...
export const IssueProperties = observer(function IssueProperties(props: IIssueProperties) {
  ...
  return (
    <div className={className}>
      ...
      >
        <Tooltip tooltipHeading={t("space_issue.sub_work_items")} tooltipContent={`${issue.sub_issues_count}`}>
          <div
            className={cn(
      ...
      >
        <Tooltip tooltipHeading={t("space_issue.attachments")} tooltipContent={`${issue.attachment_count}`}>
      ...
      >
        <Tooltip tooltipHeading={t("space_issue.links")} tooltipContent={`${issue.link_count}`}>
          <div className="flex h-5 flex-shrink-0 items-center justify-center gap-2 overflow-hidden rounded-sm border-[0.5px] border-strong px-2.5 py-1">
