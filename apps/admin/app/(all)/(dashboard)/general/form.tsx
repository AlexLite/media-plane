  ...
  return (
    <div className="space-y-8">
      <div className="space-y-4">
        <div className="text-16 font-medium text-primary">{t("instance_details")}</div>
        <div className="grid-col grid w-full grid-cols-1 items-center justify-between gap-8 md:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="flex flex-col gap-1">
            <h4 className="text-13 text-tertiary">{t("instance_id")}</h4>
            <Input
              id="instance_id"
              name="instance_id"
              type="text"
      ...
      <div className="space-y-6">
        <div className="border-b border-subtle pb-1.5 text-16 font-medium text-primary">{t("chat_telemetry")}</div>
        <div className="flex items-center gap-14">
          <div className="flex grow items-center gap-4">
            ...
            <div className="grow">
              <div className="text-13 leading-5 font-medium text-primary">{t("telemetry_collect_usage_title")}</div>
              <div className="text-11 leading-5 font-regular text-tertiary">
                {t("telemetry_collect_usage_description_prefix")}{" "}
                <a
