  ...
  return (
    <>
      ...
      <div className="cursor-default">
        <Tooltip tooltipHeading={t("pages_list.owned_by")} tooltipContent={ownerDetails?.display_name}>
      ...
      {/* page info */}
      <Tooltip tooltipContent={t("common.created_on_date", { date: renderFormattedDate(created_at) })}>
