...
const EXPORT_FORMATS: {
  ...
  {
    key: "pdf",
    i18n_label: "page_modals.export.options.format.pdf",
  },
  {
    key: "markdown",
    i18n_label: "page_modals.export.options.format.markdown",
  },
];
...
const PAGE_FORMATS: {
  ...
  {
    key: "A4",
    i18n_label: "page_modals.export.options.page_format.a4",
  },
  {
    key: "A3",
    i18n_label: "page_modals.export.options.page_format.a3",
  },
  {
    key: "A2",
    i18n_label: "page_modals.export.options.page_format.a2",
  },
  {
    key: "LETTER",
    i18n_label: "page_modals.export.options.page_format.letter",
  },
  {
    key: "LEGAL",
    i18n_label: "page_modals.export.options.page_format.legal",
  },
  {
    key: "TABLOID",
    i18n_label: "page_modals.export.options.page_format.tabloid",
  },
];
...
const CONTENT_VARIETY: {
  ...
  {
    key: "everything",
    i18n_label: "page_modals.export.options.content_variety.everything",
  },
  {
    key: "no-assets",
    i18n_label: "page_modals.export.options.content_variety.no_assets",
  },
];
  ...
  const handleExport = async () => {
    ...
    try {
      ...
      setToast({
        ...
        title: t("page_modals.export.toast.success.title"),
        message: t("page_modals.export.toast.success.message"),
      });
      handleClose();
    } catch (error) {
      ...
      setToast({
        ...
        title: t("page_modals.export.toast.error.title"),
        message: t("page_modals.export.toast.error.message"),
      });
    } finally {
    ...
    <ModalCore isOpen={isOpen} handleClose={handleClose} position={EModalPosition.CENTER} width={EModalWidth.SM}>
      <div>
        <div className="space-y-5 p-5">
          <h3 className="text-18 font-medium text-secondary">{t("page_modals.export.title")}</h3>
          <div className="space-y-3">
            <div className="flex items-center justify-between gap-2">
              <h6 className="flex-shrink-0 text-13 text-secondary">{t("page_modals.export.export_format")}</h6>
              <Controller
                control={control}
                name="export_format"
                render={({ field: { onChange, value } }) => (
                  <CustomSelect
                    label={t(EXPORT_FORMATS.find((format) => format.key === value)?.i18n_label || "")}
            ...
            <div className="flex items-center justify-between gap-2">
              <h6 className="flex-shrink-0 text-13 text-secondary">{t("page_modals.export.include_content")}</h6>
              <Controller
                control={control}
                name="content_variety"
                render={({ field: { onChange, value } }) => (
                  <CustomSelect
                    label={t(CONTENT_VARIETY.find((variety) => variety.key === value)?.i18n_label || "")}
                    buttonClassName="border-none"
                    value={value}
            ...
            {isPDFSelected && (
              <div className="flex items-center justify-between gap-2">
                <h6 className="flex-shrink-0 text-13 text-secondary">{t("page_modals.export.page_format")}</h6>
                <Controller
                  control={control}
                  name="page_format"
                  render={({ field: { onChange, value } }) => (
                    <CustomSelect
                      label={t(PAGE_FORMATS.find((format) => format.key === value)?.i18n_label || "")}
                      buttonClassName="border-none"
                      value={value}
        ...
        <div className="flex items-center justify-end gap-2 border-t-[0.5px] border-subtle px-5 py-4">
          ...
          <Button variant="primary" size="lg" loading={isExporting} onClick={handleExport}>
            {isExporting ? t("page_modals.export.exporting") : t("page_modals.export.submit")}
          </Button>
        </div>
      </div>
    </ModalCore>
