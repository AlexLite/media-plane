  ...
  return (
    <div className="flex items-center justify-between gap-4 bg-surface-1 px-5 py-4 text-13">
      <h3 className="break-words">
        {t("workspace_analytics.work_items_modal.title", { title })}
        {cycle && t("workspace_analytics.work_items_modal.in_cycle", { name: cycle.name })}
        {module && t("workspace_analytics.work_items_modal.in_module", { name: module.name })}
      </h3>
