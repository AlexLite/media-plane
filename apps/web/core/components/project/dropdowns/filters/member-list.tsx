...
const PROJECT_ROLE_OPTIONS: IRoleOption[] = [
  { value: String(EUserProjectRoles.ADMIN), labelKey: "workspace_member_roles.admin" },
  { value: String(EUserProjectRoles.MEMBER), labelKey: "workspace_member_roles.member" },
  { value: String(EUserProjectRoles.GUEST), labelKey: "workspace_member_roles.guest" },
];

const WORKSPACE_ROLE_OPTIONS: IRoleOption[] = [
  { value: String(EUserWorkspaceRoles.ADMIN), labelKey: "workspace_member_roles.admin" },
  { value: String(EUserWorkspaceRoles.MEMBER), labelKey: "workspace_member_roles.member" },
  { value: String(EUserWorkspaceRoles.GUEST), labelKey: "workspace_member_roles.guest" },
  { value: "suspended", labelKey: "workspace_member_roles.suspended" },
];
