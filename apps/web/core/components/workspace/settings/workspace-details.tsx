  ...
  const onSubmit = async (formData: IWorkspace) => {
    ...
    try {
      ...
      setToast({
        ...
        message: t("workspace_settings.settings.general.toasts.workspace_updated"),
      });
    } catch (err: unknown) {
      console.error(err);
    } finally {
  ...
  const handleRemoveLogo = async () => {
    ...
    try {
      ...
      setToast({
        type: TOAST_TYPE.SUCCESS,
        title: t("toast.success"),
        message: t("workspace_settings.settings.general.toasts.workspace_logo_removed"),
      });
    } catch {
      setToast({
        type: TOAST_TYPE.ERROR,
        title: t("toast.error"),
        message: t("profile_picture_delete_failed"),
      });
    }
  };
  ...
  const handleCopyUrl = () => {
    ...
    void copyUrlToClipboard(`${currentWorkspace.slug}`)
      .then(() => {
        setToast({
          type: TOAST_TYPE.SUCCESS,
          title: t("workspace_settings.settings.general.toasts.workspace_url_copied"),
        });
        return undefined;
      })
      .catch(() => {
