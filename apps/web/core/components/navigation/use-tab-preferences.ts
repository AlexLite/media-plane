    ...
    updatePreferences(newPreferences)
      .then(() => {
        setToast({
          ...
          message: t("navigation.toasts.default_tab_updated"),
        });
        return;
      })
      .catch(() => {
        setToast({
          ...
          title: t("toast.error"),
          message: t("navigation.toasts.default_tab_update_failed"),
        });
      });
  };
  ...
  const handleHideTab = (tabKey: string) => {
    ...
    try {
      ...
      setToast({
        type: TOAST_TYPE.ERROR,
        title: t("toast.error"),
        message: t("navigation.toasts.hide_tab_failed"),
      });
    }
  };
  ...
  const handleShowTab = (tabKey: string) => {
    ...
    try {
      ...
      setToast({
        type: TOAST_TYPE.ERROR,
        title: t("toast.error"),
        message: t("navigation.toasts.show_tab_failed"),
      });
    }
  };
