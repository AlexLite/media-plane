              ...
              <div className="flex items-center">
                ...
                {isHidden && (
                  <button
                    ...
                    title={t("tab_navigation.show")}
                  >
                    <Pin className="size-3" />
                  </button>
                )}
                <Tooltip
                  tooltipContent={isDefault ? t("tab_navigation.clear_default") : t("tab_navigation.set_as_default")}
                >
                  <button
                    onClick={(e) => {
                      e.stopPropagation();
                    ...
                    title={isDefault ? t("tab_navigation.clear_default") : t("tab_navigation.set_as_default")}
                  >
