    ...
    <div>
      ...
      {email && !emailRegex.test(email) && (
        <div className="mx-8 my-1">
          ...
          <span className="mt-1 text-11 text-danger-primary">{t("onboarding_invite_members.errors.invalid_email_hint")}</span>
        </div>
      )}
    </div>
  );
    ...
    await workspaceService
      ...
      .then(async () => {
        setToast({
          ...
          title: t("onboarding_invite_members.toast.success.title"),
      ...
      .catch((err) => {
        setToast({
          ...
          title: t("onboarding_invite_members.toast.error.title"),
          message: err?.error,
        });
      });
  };
      ...
      <div className="h-full w-full overflow-auto px-6 py-10 sm:px-7 sm:py-14 md:px-14 lg:px-28">
        <div className="mx-auto mt-6 flex w-full flex-col items-center justify-center p-8 md:w-4/5">
          <div className="mx-auto w-4/5 space-y-1 py-4 text-center">
            <h3 className="text-24 font-bold text-primary">{t("onboarding_invite_members.title")}</h3>
            <p className="font-medium text-placeholder">
              {t("onboarding_invite_members.description")}
            </p>
          </div>
          <form
          ...
          >
            <div className="w-full py-4 text-13">
              ...
              >
                ...
                {t("onboarding_invite_members.add_another")}
              </button>
            </div>
            <div className="mx-auto flex w-full max-w-96 flex-col items-center justify-center gap-4 px-8 sm:px-2">
              ...
              <Button variant="ghost" size="xl" className="w-full" onClick={nextStep}>
                {t("onboarding_invite_members.later")}
              </Button>
            </div>
          </form>
        </div>
