...
export const FilterCreatedDate = observer(function FilterCreatedDate(props: Props) {
  ...
  return (
    <>
      ...
      <FilterHeader
        title={`${t("created_date")}${appliedFiltersCount > 0 ? ` (${appliedFiltersCount})` : ""}`}
        ...
        <div>
          {filteredOptions.length > 0 ? (
            <>
              ...
              <FilterOption isChecked={isCustomDateSelected()} onClick={handleCustomDate} title="Пользовательская" multiple />
            </>
          ) : (
