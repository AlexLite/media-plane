...
export const AllIssueLayoutRoot = observer(function AllIssueLayoutRoot(props: Props) {
  ...
  if (!isLoading && !globalViewsLoading && !issuesLoading && !viewDetails && !isDefaultView) {
    return (
      <EmptyStateDetailed
        title={t("issue_layouts.view_not_found.title")}
        description={t("issue_layouts.view_not_found.description")}
        assetKey="view"
        actions={[
          {
            label: t("issue_layouts.go_to_all_work_items"),
