  ...
  return (
    <>
      ...
      {!cycle && !loader ? (
        <EmptyState
          image={emptyCycle}
          title={t("project_cycles.empty_state.not_found.title")}
          description={t("project_cycles.empty_state.not_found.description")}
          primaryButton={{
            text: t("project_cycles.empty_state.not_found.primary_button.text"),
