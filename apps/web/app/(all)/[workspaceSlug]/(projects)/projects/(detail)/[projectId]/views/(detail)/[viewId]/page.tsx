...
function ProjectViewIssuesPage({ params }: Route.ComponentProps) {
  ...
  if (error) {
    return (
      <EmptyState
        image={emptyView}
        title={t("project_views.empty_state.not_found.title")}
        description={t("project_views.empty_state.not_found.description")}
        primaryButton={{
          text: t("project_views.empty_state.not_found.primary_button.text"),
