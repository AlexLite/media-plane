...
const PROJECT_ARCHIVES_BREADCRUMB_LIST: {
  ...
  cycles: {
    labelTranslationKey: "common.cycles",
    href: "/cycles",
    icon: CycleIcon,
  },
  modules: {
    labelTranslationKey: "common.modules",
    href: "/modules",
    icon: ModuleIcon,
  },
};
      ...
      <Header.LeftItem>
        <div className="flex items-center gap-2.5">
          <Breadcrumbs onBack={router.back} isLoading={loader === "init-loader"}>
            ...
            {activeTabBreadcrumbDetail && (
              <Breadcrumbs.Item
                component={
                  <BreadcrumbLink
                    label={t(activeTabBreadcrumbDetail.labelTranslationKey)}
          ...
          {activeTab === "issues" && issueCount && issueCount > 0 ? (
            <Tooltip
              isMobile={isMobile}
              tooltipContent={t("project_archives.issue_count", { count: issueCount })}
              position="bottom"
            >
