  ...
  return (
    <>
      ...
      {error ? (
        <EmptyState
          image={emptyModule}
          title={t("project_modules.empty_state.not_found.title")}
          description={t("project_modules.empty_state.not_found.description")}
          primaryButton={{
            text: t("project_modules.empty_state.not_found.primary_button.text"),
